...
namespace QToolbar.Plugins.EnvManager
{
   public class QEnvFileSystemLoader
   {
      ...
      {
         string batchServiceConfig = $"{objEnv.ENV_CONF.ENV.BatchServiceUNCPath}\\BatchExecutorService.exe.config";
         try
         {
      ...
      {
         string eodServiceConfig = $"{objEnv.ENV_CONF.ENV.EODServiceUNCPath}\\EODExecutorService.exe.config";
         try
         {
      ...
      private void Check_cmd_commands_txt(QEnv objEnv, CancellationToken cancelToken)
      {
         ...
         if (File.Exists(cmdFile))
         {
            ...
            string uninstallBatch = $"\"{objEnv.ENV_CONF.ENV.WinServicesPath}\\Uninstall_Service.bat\" \"{objEnv.ENV_CONF.ENV.BatchServicePath}\"";
            string uninstallEod = $"\"{objEnv.ENV_CONF.ENV.WinServicesPath}\\Uninstall_Service.bat\" \"{objEnv.ENV_CONF.ENV.EODServicePath}\"";

            string installBatch = $"\"{objEnv.ENV_CONF.ENV.WinServicesPath}\\Install_Service.bat\" \"{objEnv.ENV_CONF.ENV.BatchServicePath}\"";
            string installEod = $"\"{objEnv.ENV_CONF.ENV.WinServicesPath}\\Install_Service.bat\" \"{objEnv.ENV_CONF.ENV.EODServicePath}\"";
